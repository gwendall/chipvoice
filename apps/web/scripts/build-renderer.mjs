...
for(const id of ['mario','zelda','sonic','mario-native','zelda-native'])await copyFile(`../../scores/arrangements/${id}.json`,`public/arrangement-data/${id}.json`);

await copyFile('../../scores/arrangements/sonic-native.vgm','public/arrangement-data/sonic-native.vgm');
