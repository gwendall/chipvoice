...
try{
 ...
 await writeFile(new URL('result.json',out),JSON.stringify({pass:true,errors,checks:['lazy assets','native/reference audio','continuous four-console selection','14 source parts','local polyphonic MIDI','persistent invalid import feedback','tempo and transpose','Stop wins','320/390/768 typography and overflow']},null,2));
