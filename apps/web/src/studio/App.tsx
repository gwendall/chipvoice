    ...
    <main className="demo-main">
      ...
      <section className="console" aria-label="Chipvoice musical console" onClick={event => {
        ...
        <div className="transport-row">
          <RangeControl id="tempo" label="Tempo" unit="BPM" min={40} max={300} value={doc.song.bpm} disabled={recordLocked || !doc.ready} onChange={(bpm, group) => { doc.edit(song => ({...song, bpm}), group); audio.startOnInteraction({...doc.song, bpm}); measure('edit'); }}/>
