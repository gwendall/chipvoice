...
export function SiteFooter() {
  return <footer className="site-footer"><span>chipvoice · A love letter to little sound chips.</span><div><Link href="/lab">Listening lab</Link><Link href="/about#credits">Credits</Link><a href="https://github.com/gwendall/chipvoice">GitHub ↗</a><a href="/skill.md">For agents ↗</a></div></footer>;
}
