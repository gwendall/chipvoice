...
const INTENT_BODY = {
  ...
  description:
    ...
    Object.entries(INTENTS)
      .map(
        ([role, ws]) =>
          `${role}: ${Object.entries(ws)
            .map(([w, what]) => `"${w}" (${what})`)
            .join(", ")}`,
      )
      .join(". "),
  properties: Object.fromEntries(
    Object.entries(INTENTS).map(([role, ws]) => [
      role,
      { type: "string", enum: Object.keys(ws), default: Object.keys(ws)[0] },
    ]),
  ),
};
...
const SONG_BODY = {
  ...
  properties: {
    ...
    stepsPerBeat: {
      ...
      default: 4,
      description:
        "Steps per quarter note. 12 preserves triplets alongside straight rhythms.",
    },
    chip: {
      type: "string",
      ...
      default: "2a03",
      description:
        "The NES's Ricoh 2A03, the Game Boy's DMG APU, the Mega Drive's YM2612 and SN76489, the SNES's S-DSP, or the C64's SID. The same four lines play on any, in its own idiom.",
    },
    intent: INTENT_BODY,
    order: {
      type: "array",
      ...
      description:
        "Which patterns play, in which order. Repeats are how a song gets long.",
    },
    patterns: {
      type: "array",
      minItems: 1,
      ...
      items: {
        ...
        properties: {
          lead: {
            ...
            maxLength: 4096,
            description:
              "Melody. One token per step (stepsPerBeat defaults to 4).",
          },
          chord: {
            type: "string",
            maxLength: 4096,
            description: "Harmony, arpeggiated by chordShape.",
          },
          bass: {
            type: "string",
            maxLength: 4096,
            description: "Bass. Its token count sets the pattern length.",
          },
          perc: {
            type: "string",
            maxLength: 4096,
            description: "Drums. K kick, S snare, H hat, O open hat.",
          },
          chordShape: {
            type: "array",
            minItems: 1,
            ...
            description:
              "Semitones each chord note is arpeggiated through. [[0,3,7]] minor, [[0,4,7]] major.",
          },
        },
      },
    },
    ...
    paths: {
      ...
      "/api/validate": {
        post: {
          ...
          requestBody: {
            required: true,
            content: { "application/json": { schema: SONG_BODY } },
          },
          responses: {
            "200": {
      ...
      "/api/songs": {
        post: {
          ...
          description:
            "Validates first. Returns a short id, a page, an MP3 and a WAV.",
          tags: ["songs"],
          requestBody: {
            required: true,
            content: { "application/json": { schema: SONG_BODY } },
      ...
      "/api/songs/{id}": {
        ...
        delete: {
          ...
          responses: {
            ...
            "403": {
              description: "Published by another account, or anonymously",
            },
            "404": { description: "No such song" },
          },
        },
            ...
            content: {
              "application/json": {
                schema: {
                  ...
                  required: [],
                  properties: {
                    ...SONG_BODY.properties,
                    title: {
                      anyOf: [SONG_BODY.properties.title, { type: "null" }],
                    },
                    author: {
                      anyOf: [SONG_BODY.properties.author, { type: "null" }],
                    },
                    intent: { anyOf: [INTENT_BODY, { type: "null" }] },
                  },
                },
              },
            },
        ...
        get: {
          ...
          parameters: [
            ...
            },
            {
              ...
              description:
                "Defaults to two loops; if that exceeds 30 seconds, returns 422. Use an explicit duration or export locally.",
            },
          ],
          responses: {
            ...
            "404": { description: "No such song" },
            "422": { description: "Default duration exceeds 30 seconds" },
            "429": { description: "Cold render limit reached" },
            "503": {
              description:
                "Worker busy or unavailable; retry after Retry-After",
            },
          },
        },
      },
      "/api/auth/signin": {
        post: {
          operationId: "signIn",
          summary: "Email a single-use browser sign-in link",
          tags: ["identity"],
          requestBody: {
            required: true,
            content: {
          ...
          responses: {
            "202": { description: "Link sent; valid for 30 minutes" },
            "503": { description: "Database or email unavailable" },
      ...
      "/api/auth/redeem": {
        get: {
          operationId: "redeemSignIn",
          summary: "Consume the link and set an HttpOnly session cookie",
          tags: ["identity"],
          parameters: [
            {
              name: "token",
          ...
          responses: {
            "302": {
              description:
                "Redirect home; valid tokens establish a 30-day session without changing API keys",
            },
          },
        },
      },
      "/api/auth/session": {
        ...
        delete: {
          ...
          responses: {
            ...
            "403": { description: "Cross-origin request refused" },
          },
        },
      },
      "/api/keys/{id}": {
        delete: {
          ...
          security: ACCOUNT_AUTH,
          summary: "Revoke one of your API keys; retain song ownership",
          tags: ["identity"],
          parameters: [
            {
              name: "id",
          ...
          responses: {
            ...
            "404": { description: "No such key on this account" },
          },
        },
      },
      "/api/keys": {
        get: {
          ...
          security: ACCOUNT_AUTH,
          summary: "List up to 100 account keys without secrets",
          tags: ["identity"],
          responses: {
        ...
        post: {
          ...
          summary: "Request a temporary sign-in link (legacy registration)",
          description:
            "Sends a single-use sign-in link. No permanent key is created or emailed. Existing owner keys remain valid; new agents use /api/v1/agent-requests and explicit browser authorization.",
          tags: ["identity"],
          requestBody: {
            required: true,
            content: {
              "application/json": {
                schema: {
                  ...
                  properties: {
                    ...
                    label: {
                      type: "string",
                      description: "What it is for, so you can tell keys apart",
                    },
                  },
                },
              },
          ...
          responses: {
            "202": { description: "On its way" },
            "422": { description: "Not an email address" },
          },
        },
      },
      "/api/me": {
      ...
      "/s/{id}.wav": {
        get: {
          ...
          description:
            "Same 1–30 integer seconds parameter, two-loop default, ETag revalidation and render limits as MP3.",
          tags: ["audio"],
          parameters: [
            {
              name: "id",
      ...
      schemas: {
        Measured: {
          ...
          properties: {
            loopSeconds: {
              type: "number",
              description: "One time round, at the song's tempo",
            },
            onsetsPerSecond: {
              type: "number",
              description: "Notes and hits per second, all channels",
            },
            range: {
              type: "integer",
              description: "Melodic range in semitones",
            },
            steps: { type: "integer" },
          },
        },
        Song: {
          ...
          properties: {
            ...
            mp3: {
              type: "string",
              description:
                "Audio URL: two loops, or an explicit 30-second preview for longer scores.",
            },
            wav: {
              type: "string",
              description:
                "Audio URL: two loops, or an explicit 30-second preview for longer scores. Export complete long scores locally.",
            },
            forks: { type: "integer" },
            depth: {
              type: "integer",
              description: "0 for an original, 1 for its fork",
            },
            rootId: {
              type: "string",
              description: "The first ancestor. Fetch the whole family with it",
            },
            authorVerified: {
              type: "boolean",
              description:
...
export function endpointRows() {
  ...
  for (const [path, operations] of Object.entries(spec.paths)) {
    for (const [method, operation] of Object.entries(
      operations as Record<string, { summary?: string }>,
    )) {
      rows.push({
