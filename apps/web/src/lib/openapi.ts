  ...
  return {
    ...
    info: {
      ...
      description:
        ...
        "Four chips: the NES's 2A03, the Game Boy's APU, the Mega Drive's YM2612 with its PSG and the SNES's S-DSP, each emulated at the clock level; what has been verified " +
